...
async function main() {
    try {
        ...
        // Membaca fail cookies.txt yang kita bina dari GitHub Secret
        const realM3u8Url = execSync(`yt-dlp --cookies cookies.txt -g -f "best[ext=mp4]/best" ${youtubeUrl}`).toString().trim();
